...
<!-- CHESS-START -->
Anyone can play! Move for whichever side is up. It's **White's** turn. Pick a move below: it opens a pre-filled GitHub issue, and pressing **Create** makes your move. The board updates in about a minute.

<img src="generated/chess-board.svg" alt="Current chess board" width="400">

| Piece | Available moves |
|-------|-----------------|
| ♙ a2 | [a3](https://github.com/ali-jifi/ali-jifi/issues/new?title=chess%7Cmove%7Ca2a3&body=Just+press+%2A%2ACreate%2A%2A+below+to+play+%2A%2Aa3%2A%2A.+A+GitHub+Action+will+make+your+move+on+%40ali-jifi%27s+profile+board+and+close+this+issue+automatically.+Thanks+for+playing%21) · [a4](https://github.com/ali-jifi/ali-jifi/issues/new?title=chess%7Cmove%7Ca2a4&body=Just+press+%2A%2ACreate%2A%2A+below+to+play+%2A%2Aa4%2A%2A.+A+GitHub+Action+will+make+your+move+on+%40ali-jifi%27s+profile+board+and+close+this+issue+automatically.+Thanks+for+playing%21) |
| ♘ b1 | [Na3](https://github.com/ali-jifi/ali-jifi/issues/new?title=chess%7Cmove%7Cb1a3&body=Just+press+%2A%2ACreate%2A%2A+below+to+play+%2A%2ANa3%2A%2A.+A+GitHub+Action+will+make+your+move+on+%40ali-jifi%27s+profile+board+and+close+this+issue+automatically.+Thanks+for+playing%21) · [Nc3](https://github.com/ali-jifi/ali-jifi/issues/new?title=chess%7Cmove%7Cb1c3&body=Just+press+%2A%2ACreate%2A%2A+below+to+play+%2A%2ANc3%2A%2A.+A+GitHub+Action+will+make+your+move+on+%40ali-jifi%27s+profile+board+and+close+this+issue+automatically.+Thanks+for+playing%21) |
